# -*- coding: utf-8 -*-
"""
Created on Mon Jun 13 16:58:08 2022
...
#integration_time = 5.e5
	...
	from test_utils import buildmodel2 as buildmodel
	model = buildmodel()
	model.summary()
	model.load_weights('weight_QGSM2.h5')
...
[xgrd,ygrd] = np.meshgrid(range(401),range(36))
...
plt.ylim([0,35])
plt.xticks([])
plt.xticks(np.arange(0,10,2),fontsize=18)
plt.xlim([0,10])
plt.colorbar()
plt.xlabel('Model Steps',fontsize=18)
plt.savefig("HybridM2.tiff", dpi=300)
