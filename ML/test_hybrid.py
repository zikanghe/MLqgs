# -*- coding: utf-8 -*-
"""
Created on Fri Jun 10 16:28:42 2022
...
# Saving the model state n steps
	def step(X0, t0, dt):
	      ...
	      y02 = dt*ml_step(y.T[..., np.newaxis]).squeeze()
	      y02 =y02.T
	      output2 = y0+y02
	      return output2
	def step2(x0, t0, dt):
...
#integration_time = 5.e5
   ...
   #4:Obs
	...
	HMM2 = HiddenMarkovModel(Dyn2, Obs, t, X0)
...
# In[integrate]
	...
	Dyn, chrono = HMM2.Dyn, HMM2.t
	N=1
	xx = np.zeros((HMM2.t.K+1, N, Dyn.M))
	X0 = HMM2.X0.sample(N)
	#Initial time step
	xx[0] = X0
