# -*- coding: utf-8 -*-
"""
Created on Mon Jun 13 16:38:24 2022
...
#File of the
	...
	# SAVE HISTORY
	np.savez('history_QGSM2.npz',
		loss=history.history['loss'],
		val_loss=history.history['val_loss'])

	# SAVE WEIGHTS
	model.save_weights('weight_QGSM2.h5')
...
# In[]
	...
	history = np.load('history_QGSM2.npz')
	fig, ax = plt.subplots()
	...
	ax.set_yscale('log')
	ax.legend()
	plt.savefig("LossM2.tiff", dpi=300)
