# -*- coding: utf-8 -*-
"""
Created on Mon Jun 13 10:08:16 2022
...
parser.add_argument('--model',nargs='?',
	default='config/model_hybrid.yml',
...
if model['type'] == 'hybrid':
	...
	archi = params['archi']
	parnn = params['parnn']
	from l2s_utils import build_HMM_resolv2 as build_HMM_resolv
...
for dparam in seq_param:
	...
	np.savez('hybridM2.npz', xx=xx[idx0:], T=T, dt=HMM.t.dt)
